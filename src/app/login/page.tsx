      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <div className="mt-6 flex flex-col space-y-2">
            <Button variant="outline" onClick={() => signIn("github",{redirectTo:"/dashboard"})} className="w-full flex gap-2">
              <GitHubLogoIcon />
              Iniciar sesión con GitHub
            </Button>
            <Button variant="outline" onClick={() => signIn("google",{redirectTo:"/dashboard"})} className="w-full">
        ...
        <CardFooter className="text-center text-sm text-muted-foreground justify-center">
          Asegúrate de estar registrado con un proveedor válido
        </CardFooter>
      </Card>
    </div>
  )
